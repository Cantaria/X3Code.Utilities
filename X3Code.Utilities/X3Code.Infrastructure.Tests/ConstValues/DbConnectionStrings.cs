namespace X3Code.Infrastructure.Tests.ConstValues
{
    ...
    {
        private const string LocalClemensConnectionString = "Server=virtual.local;Database=UnitTest;User Id=SA;Password=Password1;TrustServerCertificate=True";   //VM Server
