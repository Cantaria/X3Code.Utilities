...
namespace X3Code.Utils.Web
{
    public static class MimeTypes
    {
                ...
                public const string Mp4  = "video/mpeg";
                ...
                public const string Abi  = "application/x-abiword";
                ...
                public const string Jsonld = "text/ld+json";
                ...
                public const string Default = "application/octet-stream"; //default for every else
}
}